...
const STEPS = [
  ...
  { title: "অনুরোধ পান", body: "আপনার এলাকা ও সেবার সাথে মিলে গেলে কাজের অনুরোধ সরাসরি আপনার কাছে আসবে।" },
  { title: "কোটেশন পাঠান", body: "দাম ও সময় জানিয়ে উত্তর দিন। গ্রাহক রাজি হলে কাজ আপনার।" },
];
...
const FAQS = [
  ...
  },
  {
    ...
    a: "আপনি যে সেবা ও এলাকা বেছে নেবেন, সেই অনুযায়ী অনুরোধ আপনার ড্যাশবোর্ডে আসবে। পছন্দ হলে গ্রহণ করে কোটেশন পাঠাবেন।",
  },
  {
    q: "টাকা কবে পাব?",
