...
const DETAIL = [
  ...
  {
    title: "কোটেশন পান",
    body: "ঘরলি টিম আপনার এলাকার যাচাইকৃত পেশাদারদের সাথে কথা বলে উপযুক্ত একজনকে ঠিক করে, দাম ও সময় জানিয়ে কোটেশন পাঠাবে।",
    points: ["পেশাদারের নাম, ছবি ও রেটিং দেখুন", "দাম আগে থেকেই ঠিক করা", "প্রশ্ন থাকলে ঘরলি টিমকে লিখুন"],
  },
  {
    title: "বুক করুন",
    body: "কোটেশন গ্রহণ করলেই বুকিং নিশ্চিত হয়। পছন্দ না হলে প্রত্যাখ্যান করুন — আমরা অন্য পেশাদার খুঁজব।",
  ...
  },
  {
    ...
    points: ["রেটিং দিন", "অভিজ্ঞতা লিখুন", "পরের কাজে আমরা মনে রাখব"],
  },
];
...
const FAQS = [
  {
    ...
    a: "না। অনুরোধ পাঠানো, কোটেশন দেখা এবং ঘরলি টিমের সাথে কথা বলা সম্পূর্ণ বিনামূল্যে। আপনি শুধু কাজের জন্য টাকা দেবেন।",
  },
  {
